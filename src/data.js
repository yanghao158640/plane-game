...
export const WEAPONS = {
  pulse: {
    ...
    pattern: 'pulse',
    levels: [
      { damage: 7, fireRate: 0.28, count: 1, speed: 720, pierce: 1 },
      { damage: 10, fireRate: 0.26, count: 1, speed: 760, pierce: 2 },
      { damage: 13, fireRate: 0.22, count: 2, speed: 800, pierce: 2 },
      { damage: 18, fireRate: 0.20, count: 2, speed: 840, pierce: 3 },
      { damage: 25, fireRate: 0.16, count: 3, speed: 900, pierce: 4 },
    ],
    evolve: 'pulse_lance',
  },
  spread: {
    ...
    pattern: 'spread',
    levels: [
      { damage: 5, fireRate: 0.34, count: 3, spread: 0.4, speed: 620 },
      { damage: 6, fireRate: 0.32, count: 4, spread: 0.5, speed: 640 },
      { damage: 8, fireRate: 0.28, count: 5, spread: 0.6, speed: 660 },
      { damage: 10, fireRate: 0.26, count: 6, spread: 0.7, speed: 680 },
      { damage: 14, fireRate: 0.22, count: 8, spread: 0.9, speed: 720 },
    ],
  },
  homing: {
    ...
    pattern: 'homing',
    levels: [
      { damage: 11, fireRate: 0.5, count: 1, speed: 360, turn: 4, life: 2.5 },
      { damage: 13, fireRate: 0.48, count: 2, speed: 380, turn: 4.5, life: 2.5 },
      { damage: 17, fireRate: 0.44, count: 2, speed: 400, turn: 5, life: 2.8 },
      { damage: 22, fireRate: 0.40, count: 3, speed: 420, turn: 5.5, life: 3.0 },
      { damage: 29, fireRate: 0.34, count: 4, speed: 450, turn: 6, life: 3.2 },
    ],
    evolve: 'swarm',
  },
  plasma: {
    ...
    pattern: 'plasma',
    levels: [
      { damage: 4, fireRate: 0.18, count: 1, speed: 280, radius: 14, life: 1.6 },
      { damage: 5, fireRate: 0.16, count: 1, speed: 300, radius: 16, life: 1.8 },
      { damage: 7, fireRate: 0.14, count: 2, speed: 320, radius: 18, life: 2.0 },
      { damage: 9, fireRate: 0.12, count: 2, speed: 340, radius: 20, life: 2.2 },
      { damage: 12, fireRate: 0.10, count: 3, speed: 360, radius: 22, life: 2.4 },
    ],
  },
  drone: {
    ...
    pattern: 'drone',
    levels: [
      { damage: 4, fireRate: 0.3, count: 1, speed: 600 },
      { damage: 5, fireRate: 0.28, count: 1, speed: 620 },
      { damage: 7, fireRate: 0.26, count: 2, speed: 640 },
      { damage: 10, fireRate: 0.24, count: 2, speed: 660 },
      { damage: 13, fireRate: 0.20, count: 3, speed: 700 },
    ],
  },
  blade: {
    ...
    pattern: 'blade',
    levels: [
      { damage: 8, fireRate: 0.6, count: 1, speed: 360, radius: 30, life: 2.0 },
      { damage: 11, fireRate: 0.56, count: 1, speed: 380, radius: 32, life: 2.2 },
      { damage: 14, fireRate: 0.52, count: 2, speed: 400, radius: 34, life: 2.4 },
      { damage: 19, fireRate: 0.48, count: 2, speed: 420, radius: 36, life: 2.6 },
      { damage: 26, fireRate: 0.42, count: 3, speed: 460, radius: 40, life: 3.0 },
    ],
  },
};
...
// ───────────────────────── 阶段感知对话系统 ─────────────────────────
// 按阶段分类，触发不同台词
export const BUBBLE_ENEMY = {
  spawn: ['发现目标！', '开火！', '别跑！', '支援！', '锁定！', '又来一个', '冲啊！'],
  hit:   ['啊！', '好痛！', '不好！', '顶住！', '咦？', '拦住他！', '可恶！'],
  death: ['不！', '撤退！', '拼了！', '啊啊啊！', '我还会回来的...', '该死！'],
};
export const BUBBLE_BOSS = {
  enter: ['蝼蚁！也敢造次？', '不自量力！', '找死！', '哼！', '区区人类，滚！', '受死吧！'],
  fight: ['就这？就这？', '认真起来了', '看招！', '绝望吧！', '死吧！', '还没完呢！', '太弱了！', '挠痒痒吗？'],
  lowHp: ['不可能！', '这...这是什么力量', '你惹怒我了！', '还没完！', '我要认真了！', '我还没输！', '同归于尽吧！'],
  death: ['这是什么怪物...', '不！不可能！', '我还会回来的...！', '你等着！', '啊！', '这不可能...'],
};
